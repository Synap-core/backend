...
echo "=== Setup Complete ==="
echo ""
echo "  Hub API Key:  $HUB_API_KEY"
echo "  Agent User:   $AGENT_USER_ID"
echo "  Workspace:    $WORKSPACE_ID"
echo ""
echo "IMPORTANT: Save your API key - it will not be shown again."
echo ""
echo "OpenClaw is now connected to your Synap pod."
echo "Install the synap-memory skill:"
echo "  openclaw skill install https://raw.githubusercontent.com/synap-core/backend/main/skills/synap-memory/SKILL.md"
