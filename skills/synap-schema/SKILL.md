...
| deal     | —        | Sales deal / lead                             | workspace    | dealStage (lead/contacted/qualifying/proposal/negotiating/won/lost/inactive), estimatedValue, closeDate, linkedTo (person/company) |
| client   | —        | Post-win relationship (auto-created on won)   | workspace    | clientStatus (active/paused/churned), producedByDeal, isClientFor (person/company)                                                 |
