...
import { workspaces, workspaceMembers, entities, documents } from '@synap/database/schema';
...
async function runTests() {
  ...
  try {
    ...
    console.log(`  ✓ User 1 can see workspace: ${user1Workspaces.length === 1}`);
    ...
    console.log(`  ✓ User 2 cannot see workspace: ${user2Workspaces.length === 0}`);
