...
export const events = pgTable('events', {
  ...
  subjectIdx: index('idx_events_subject')
    .on(table.subjectType, table.subjectId, table.timestamp),
  
  // INDEX: For querying by user and event type
  userTypeIdx: index('idx_events_user_type')
    .on(table.userId, table.type),
  
  // INDEX: For time-based queries
  timestampIdx: index('idx_events_timestamp')
    .on(table.timestamp),
}));
