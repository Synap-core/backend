 ...
 */
export var ThreadDocumentRelationshipType;
(function (ThreadDocumentRelationshipType) {
    ThreadDocumentRelationshipType["USED_AS_CONTEXT"] = "used_as_context";
    ThreadDocumentRelationshipType["CREATED"] = "created";
    ThreadDocumentRelationshipType["UPDATED"] = "updated";
    ThreadDocumentRelationshipType["REFERENCED"] = "referenced";
    ThreadDocumentRelationshipType["INHERITED_FROM_PARENT"] = "inherited_from_parent";
})(ThreadDocumentRelationshipType || (ThreadDocumentRelationshipType = {}));
/**
 * Thread Document Conflict Status
 */
export var ThreadDocumentConflictStatus;
(function (ThreadDocumentConflictStatus) {
    ThreadDocumentConflictStatus["NONE"] = "none";
    ThreadDocumentConflictStatus["PENDING"] = "pending";
    ThreadDocumentConflictStatus["RESOLVED"] = "resolved";
})(ThreadDocumentConflictStatus || (ThreadDocumentConflictStatus = {}));
export const threadDocuments = pgTable("thread_documents", {
    // Identity
    ...
    documentIdIdx: index("thread_documents_document_id_idx").on(table.documentId),
    // User/workspace filtering (RLS)
    userIdIdx: index("thread_documents_user_id_idx").on(table.userId),
    workspaceIdIdx: index("thread_documents_workspace_id_idx").on(table.workspaceId),
    // Conflict queries
    conflictIdx: index("thread_documents_conflict_idx").on(table.conflictStatus),
    // Prevent duplicate relationships
    uniqueRelationship: unique("thread_documents_unique").on(table.threadId, table.documentId, table.relationshipType),
}));
...
//# sourceMappingURL=thread-documents.js.map