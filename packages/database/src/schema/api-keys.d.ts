 ...
 */
export declare const API_KEY_SCOPES: readonly ["preferences", "calendar", "notes", "tasks", "projects", "conversations", "entities", "relations", "knowledge_facts", "write:entities", "read:entities", "ai:analyze", "webhook:manage", "hub-protocol.read", "hub-protocol.write", "mcp.read", "mcp.write"];
