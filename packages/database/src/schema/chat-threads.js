...
export const chatThreads = pgTable("chat_threads", {
    ...
    workspaceIdIdx: index("chat_threads_workspace_id_idx").on(table.workspaceId),
    parentThreadIdx: index("chat_threads_parent_thread_id_idx").on(table.parentThreadId),
