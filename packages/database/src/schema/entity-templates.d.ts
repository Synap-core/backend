export declare const entityTemplates: import("drizzle-orm/pg-core").PgTableWithColumns<{
  ...
  columns: {
    ...
    entityType: import("drizzle-orm/pg-core").PgColumn<
      ...
      {}
    >;
    inboxItemType: import("drizzle-orm/pg-core").PgColumn<
      {
 ...
 */
export declare const insertEntityTemplateSchema: import("drizzle-zod").BuildSchema<
  "insert",
  {
    id: import("drizzle-orm/pg-core").PgColumn<
      {
 ...
 * @internal For monorepo usage - enables schema composition in API layer
 */
export declare const selectEntityTemplateSchema: import("drizzle-zod").BuildSchema<
  "select",
  {
    id: import("drizzle-orm/pg-core").PgColumn<
      {
