 ...
 */
export declare const insertEntityTemplateSchema: import("drizzle-zod").BuildSchema<"insert", {
    id: import("drizzle-orm/pg-core").PgColumn<{
        name: "id";
        tableName: "entity_templates";
        dataType: "string";
 ...
 * @internal For monorepo usage - enables schema composition in API layer
 */
export declare const selectEntityTemplateSchema: import("drizzle-zod").BuildSchema<"select", {
    id: import("drizzle-orm/pg-core").PgColumn<{
        name: "id";
        tableName: "entity_templates";
        dataType: "string";
