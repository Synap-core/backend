...
export const inboxItems = pgTable("inbox_items", {
    ...
    timestampIdx: index("idx_inbox_timestamp").on(table.userId, table.timestamp),
...
//# sourceMappingURL=inbox-items.js.map