...
import { pgTable, uuid, text, boolean, timestamp, bigint, unique, check } from 'drizzle-orm/pg-core';
...
export const apiKeys = pgTable('api_keys', {
  ...
  scope: text('scope').array().notNull().default(sql`'{}'::text[]`), // Granular permissions
  ...
  rotationScheduledAt: timestamp('rotation_scheduled_at', { withTimezone: true }),
