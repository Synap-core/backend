 ...
 */
export declare const insertProfilePropertySchema: import("drizzle-zod").BuildSchema<
  "insert",
  {
    profileId: import("drizzle-orm/pg-core").PgColumn<
      {
  ...
  undefined
>;
export declare const selectProfilePropertySchema: import("drizzle-zod").BuildSchema<
  "select",
  {
    profileId: import("drizzle-orm/pg-core").PgColumn<
      {
