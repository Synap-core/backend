...
export const intelligenceCommands = pgTable("intelligence_commands", {
    ...
    workspaceIdIdx: index("intelligence_commands_workspace_id_idx").on(table.workspaceId),
    createdByIdx: index("intelligence_commands_created_by_idx").on(table.createdBy),
}));
