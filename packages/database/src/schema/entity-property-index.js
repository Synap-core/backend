 ...
 */
import { pgTable, uuid, text, numeric, boolean, timestamp, jsonb, primaryKey, index, } from "drizzle-orm/pg-core";
import { entities } from "./entities.js";
import { propertyDefs } from "./property-defs.js";
import { createInsertSchema, createSelectSchema } from "drizzle-zod";
export const entityPropertyIndex = pgTable("entity_property_index", {
    ...
    propertyValueTextIdx: index("entity_property_index_property_value_text_idx").on(table.propertyDefId, table.valueText),
    propertyValueNumIdx: index("entity_property_index_property_value_num_idx").on(table.propertyDefId, table.valueNum),
    propertyValueBoolIdx: index("entity_property_index_property_value_bool_idx").on(table.propertyDefId, table.valueBool),
    propertyValueTsIdx: index("entity_property_index_property_value_ts_idx").on(table.propertyDefId, table.valueTs),
    propertyValueEntityIdx: index("entity_property_index_property_value_entity_idx").on(table.propertyDefId, table.valueEntityId),
 ...
 */
export const insertEntityPropertyIndexSchema = createInsertSchema(entityPropertyIndex);
export const selectEntityPropertyIndexSchema = createSelectSchema(entityPropertyIndex);
//# sourceMappingURL=entity-property-index.js.map