 ...
 */
import { pgTable, uuid, timestamp, jsonb, text, index, primaryKey, } from "drizzle-orm/pg-core";
export const events = pgTable("events", {
    ...
    subjectIdx: index("idx_events_subject").on(table.subjectType, table.subjectId, table.timestamp),
