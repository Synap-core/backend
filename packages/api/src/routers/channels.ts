...
export const channelsRouter = router({
  ...
  addRoomMember: membershipProcedures.addRoomMember,
  removeRoomMember: membershipProcedures.removeRoomMember,
  listRoomMemberCandidates: membershipProcedures.listRoomMemberCandidates,
