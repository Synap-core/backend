  ...
  async list(ctx?: ToolsListContext): Promise<Tool[]> {
    const toolDefs: Tool[] = [
      ...
      },
      {
        ...
        description:
          "List all workspaces visible to you (pod-wide). Returns workspace details including role, access kind, entity counts, template health, and usedByProjectIds (additive INDEX of projects using each workspace). NOT an ACL — visibility is floored to what you can see.",
        inputSchema: {
          type: "object",
          properties: {
            includeArchived: {
      ...
      },
      {
        ...
        description:
          "List all projects visible to you (pod-wide). Returns paginated results with subject entity, phase category, and usedWorkspaceIds for each project. NOT an ACL — visibility is floored to what you can see.",
        inputSchema: {
          type: "object",
          properties: {
            status: {
