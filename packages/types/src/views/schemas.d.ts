...
export declare const RenderSettingsSchema: z.ZodObject<{
    ...
    graphLayout: z.ZodOptional<z.ZodEnum<{
        force: "force";
 ...
 */
export declare const ViewContentSchema: z.ZodDiscriminatedUnion<[z.ZodObject<{
 ...
 */
export declare function parseViewContent(raw: unknown): z.infer<typeof ViewContentSchema>;
/**
 ...
 */
export declare function safeParseViewContent(raw: unknown): z.ZodSafeParseResult<{
    [x: string]: unknown;
    version: 1;
    category: "structured";
    query: {
        ...
        filters?: {
            field: string;
            operator: "in" | "equals" | "contains" | "gt" | "gte" | "lt" | "lte" | "notIn" | "between";
            value: unknown;
        }[] | undefined;
        sorts?: {
            field: string;
    ...
    render?: {
        [x: string]: unknown;
        layout?: "table" | "calendar" | "list" | "grid" | "timeline" | "graph" | "kanban" | "gallery" | "gantt" | undefined;
 ...
 */
export declare function validateContentCategoryForViewType(viewType: string, content: z.infer<typeof ViewContentSchema>): boolean;
