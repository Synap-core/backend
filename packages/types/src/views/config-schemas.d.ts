...
export declare const KanbanViewConfigSchema: z.ZodObject<{
    ...
    cardSettings: z.ZodOptional<z.ZodObject<{
 ...
 */
export declare function getConfigSchemaForViewType(viewType: string): z.ZodSchema | null;
/**
 ...
 */
export declare function validateViewConfig(viewType: string, config: unknown): {
    valid: boolean;
    errors?: z.ZodError;
};
