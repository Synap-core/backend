 ...
 */
export declare const SUBJECT_TYPES: readonly [
  "entity",
  "document",
  "workspace",
  "view",
...
export declare const EVENT_ACTIONS: readonly [
  "create",
  "update",
  "delete",
  "archive",
...
export declare const EVENT_PHASES: readonly [
  "requested",
  "validated",
  "completed",
  "denied",
 ...
 */
export declare function buildEventName<
