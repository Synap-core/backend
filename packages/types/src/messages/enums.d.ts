 ...
 */
export type MessageLinkTargetTypeString = `${MessageLinkTargetType}` | (string & {});
/**
 ...
 * String literal union type (for flexibility)
 */
export type MessageLinkRelationshipTypeString = `${MessageLinkRelationshipType}` | (string & {});
/**
 * Zod schemas for validation
 */
import { z } from "zod";
export declare const MessageLinkTargetTypeSchema: z.ZodEnum<typeof MessageLinkTargetType>;
export declare const MessageLinkRelationshipTypeSchema: z.ZodEnum<typeof MessageLinkRelationshipType>;
