  ...
  get(_target, prop) {
    ...
    if (!_config) {
      ...
      return async (...args: unknown[]) => {
        ...
        const method = (instance as unknown as Record<string, unknown>)[prop as string];
    ...
    const value = (_storageInstance as unknown as Record<string, unknown>)[prop as string];
