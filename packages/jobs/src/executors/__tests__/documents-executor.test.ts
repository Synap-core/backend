...
describe('DocumentsExecutor', () => {
  ...
  it('should handle create action', async () => {
    ...
    expect(mockStep.run).toHaveBeenNthCalledWith(1, "upload-file", expect.any(Function));
    expect(mockStep.run).toHaveBeenNthCalledWith(2, "create-document", expect.any(Function));
  ...
  it('should handle update action', async () => {
    ...
    expect(mockStep.run).toHaveBeenCalledWith("update-document", expect.any(Function));
  ...
  it('should handle delete action', async () => {
    ...
    expect(mockStep.run).toHaveBeenCalledWith("delete-document", expect.any(Function));
