...
declare const ChannelPurpose: {
	readonly CHAT: "chat";
	readonly FEED: "feed";
	readonly AUDIT: "audit";
};
export type ChannelPurpose = (typeof ChannelPurpose)[keyof typeof ChannelPurpose];
...
export declare const coreRouter: import("@trpc/server").TRPCBuiltRouter<{
	...
	events: import("@trpc/server").TRPCBuiltRouter<{
		...
		log: import("@trpc/server").TRPCMutationProcedure<{
			input: {
				subjectId: string;
				subjectType: "user" | "message" | "apiKey" | "system" | "chat" | "entity" | "document" | "task" | "workspace" | "relation" | "project" | "member";
				eventType: string;
				data: Record<string, unknown>;
				version: number;
		...
		search: import("@trpc/server").TRPCQueryProcedure<{
			input: {
				...
				subjectType?: "user" | "message" | "apiKey" | "system" | "chat" | "entity" | "document" | "task" | "workspace" | "relation" | "project" | "member" | undefined;
		...
		createChannel: import("@trpc/server").TRPCMutationProcedure<{
			...
			output: {
				...
				channel: {
					...
					channelPurpose: "audit" | "chat" | "feed" | null;
					contextObjectType: string | null;
					contextObjectId: string | null;
					parentChannelId: string | null;
					branchedFromMessageId: string | null;
	...
	skills: import("@trpc/server").TRPCBuiltRouter<{
		...
		createTrigger: import("@trpc/server").TRPCMutationProcedure<{
			input: {
				...
				channelType?: "personal" | "new_thread" | undefined;
			};
			output: {
				userId: string;
				workspaceId: string;
				...
				createdAt: Date;
				isActive: boolean;
				channelType: "personal" | "new_thread";
