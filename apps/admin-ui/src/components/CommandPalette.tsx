...
export default function CommandPalette({ open, onClose }: CommandPaletteProps) {
  ...
  return (
    <Modal state={state}>
      ...
      >
        <Modal.Dialog
          className="relative flex h-[min(660px,88vh)] w-[min(760px,95vw)] max-w-[760px] flex-col overflow-hidden rounded-3xl border border-divider text-foreground shadow-2xl"
          style={{
            backgroundColor: "var(--color-content1)",
            backdropFilter: "none",
